...
class SendTheme {
    ...
    static let twinHeight: CGFloat = 182
    ...
    static let sendButtonTopMargin: CGFloat = 23
    ...
    static let sendButtonItemHeight: CGFloat = 89
    ...
    static let backButtonTopMargin:CGFloat = 9
