...
class TransactionInfoTheme {
    ...
    static let titleColor = UIColor.cryptoDark
    static let titleFont = UIFont.cryptoHeadline
    static let amountFont = UIFont.cryptoHeadline
    static let closeButtonTextColor = UIColor.cryptoGreen
    static let closeButtonTextColorSelected = UIColor.cryptoGreenPressed
