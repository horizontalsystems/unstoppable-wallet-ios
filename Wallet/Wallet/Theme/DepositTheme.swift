...
class DepositTheme {
    ...
    static let copyHeight: CGFloat = 42
    static let copyTextColor = UIColor.cryptoGreen
    ...
    static let shareButtonTopMargin: CGFloat = 12
    static let shareButtonSideMargin: CGFloat = 16
    static let shareButtonHeight: CGFloat = 50
    static let shareButtonItemHeight: CGFloat = 78
