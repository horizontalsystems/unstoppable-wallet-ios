...
class SettingsLanguageController: UIViewController, SectionsDataSource {
    ...
    func buildSections() -> [SectionProtocol] {
        ...
        sections.append(Section(id: "languages", headerState: .margin(height: SettingsTheme.languageHeaderHeight), footerState: .margin(height: SettingsTheme.languageHeaderHeight), rows: availableLanguages.map { language in
