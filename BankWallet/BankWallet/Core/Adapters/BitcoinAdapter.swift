...
class BitcoinAdapter: BitcoinBaseAdapter {
    ...
    init(wallet: Wallet, addressParser: IAddressParser, feeRateProvider: IFeeRateProvider, testMode: Bool) throws {
        ...
        bitcoinKit = try BitcoinKit(withWords: words, walletId: wallet.account.uniqueId, syncMode: BitcoinBaseAdapter.kitMode(from: wallet.syncMode), networkType: networkType, minLogLevel: .error)
