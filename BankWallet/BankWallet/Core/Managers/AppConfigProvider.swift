...
class AppConfigProvider: IAppConfigProvider {
    ...
    let coins = [
        ...
        Coin(title: "Ankr Network",          code: "ANKR",      type: .binance(symbol: "ANKR")),
        ...
        Coin(title: "Bitcoin BEP2",          code: "BTCB",      type: .binance(symbol: "BTCB")),
        Coin(title: "Cashaa",                code: "CAS",       type: .binance(symbol: "CAS")),
        Coin(title: "ChainLink",             code: "LINK",      type: .erc20(address: "0x514910771AF9Ca656af840dff83E8264EcF986CA", decimal: 18, fee: 0)),
        Coin(title: "Crypterium",            code: "CRPT",      type: .binance(symbol: "CRPT")),
        ...
        Coin(title: "Gifto",                 code: "GTO",       type: .binance(symbol: "GTO")),
        ...
        Coin(title: "MEET.ONE",              code: "MEETONE",   type: .eos(token: "eosiomeetone", symbol: "MEETONE")),
        Coin(title: "Mithril",               code: "MITH",      type: .erc20(address: "0x3893b9422Cd5D70a81eDeFfe3d5A1c6A978310BB", decimal: 18, fee: 0)),
        Coin(title: "Native Utility Token",  code: "NUT",       type: .eos(token: "eosdtnutoken", symbol: "NUT")),
        Coin(title: "Newdex",                code: "NDX",       type: .eos(token: "newdexissuer", symbol: "NDX")),
        ...
        Coin(title: "Paytomat",              code: "PTI",       type: .eos(token: "ptitokenhome", symbol: "PTI")),
        ...
        Coin(title: "Prospectors Gold",      code: "PGL",       type: .eos(token: "prospectorsg", symbol: "PGL")),
