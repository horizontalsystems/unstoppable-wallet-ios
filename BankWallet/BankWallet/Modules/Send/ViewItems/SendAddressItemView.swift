...
class SendAddressItemView: BaseActionItemView {
    let addressInputField = AddressInputField(frame: .zero, placeholder: "send.address_placeholder".localized, showQrButton: false, canEdit: false, lineBreakMode: .byTruncatingMiddle)
