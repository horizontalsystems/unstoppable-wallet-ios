...
class SendAmountRouter {
    ...
    static func module(coin: Coin) -> (UIView, ISendAmountModule) {
        ...
        let interactor = SendAmountInteractor(localStorage: App.shared.localStorage, rateManager: App.shared.rateManager, currencyManager: App.shared.currencyManager)
