...
extension RateListRouter {
    ...
    static func module() -> UIViewController {
        ...
        let interactor = RateListInteractor(rateManager: App.shared.rateManager, currencyManager: App.shared.currencyManager, walletManager: App.shared.walletManager, appConfigProvider: App.shared.appConfigProvider)
