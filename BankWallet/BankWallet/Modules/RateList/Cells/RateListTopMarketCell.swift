...
class RateListTopMarketCell: ClaudeThemeCell {
    private let leftCoinView = LeftCoinNameCellView()
    ...
    func bind(viewItem: TopRateViewItem, last: Bool = false) {
        super.bind(last: last)

        leftCoinView.bind(title: viewItem.coinTitle, code: viewItem.coinCode)
