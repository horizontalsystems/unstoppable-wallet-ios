...
enum BottomAlertItemType {
    ...
    case description(text: String, important: Bool, last: Bool)
...
class BottomAlertViewController: WalletActionSheetController {
    ...
    init(items: [BottomAlertItemType]) {
        ...
        items.enumerated().forEach { index, item in
            ...
            case let .description(text, important, last):
                model.addItemView(AlertTextItem(text: text, important: important, last: last, tag: index))
