...
class TransactionInfoViewController: ActionSheetController {
    ...
    override func viewDidLoad() {
        ...
        if let value = item.rate, let formattedValue = ValueFormatter.instance.format(currencyValue: value, fractionPolicy: .threshold(threshold: 1000), smallValueThreshold: 0.1, trimmable: false) {
