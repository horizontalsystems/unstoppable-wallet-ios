...
extension UIFont {
    ...
    static let cryptoBody2Italic = UIFont.systemFont(ofSize: 15, weight: .regular).with(traits: .traitItalic)
    ...
    static let cryptoCaption4 = UIFont.systemFont(ofSize: 10, weight: .regular)
