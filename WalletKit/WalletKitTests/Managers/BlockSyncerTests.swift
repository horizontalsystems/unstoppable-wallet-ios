...
class BlockSyncerTests: XCTestCase {
    ...
    func testSync_NonSyncedBlocks() {
        ...
        try! realm.write {
            realm.create(Block.self, value: ["reversedHeaderHashHex": archivedHash.reversedHex, "headerHash": archivedHash, "height": 1, "archived": true, "synced": false], update: true)
    ...
    func testSync_OnDisconnect() {
        let hash = "000000000000002ca33390dac7a0b98b222b762810f2dda0a00ecf2c1cdf361b".reversedData!
        try! realm.write {
            realm.create(Block.self, value: ["reversedHeaderHashHex": hash.reversedHex, "headerHash": hash, "height": 1, "archived": false, "synced": false], update: true)
        }
