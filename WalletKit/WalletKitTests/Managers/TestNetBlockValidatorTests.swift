...
class TestNetBlockValidatorTests: XCTestCase {
    ...
    override func setUp() {
        ...
        previousSmallTimeSpanBlock = Block(
                header: BlockHeader(version: 536870912, previousBlockHeaderReversedHex: "0000000000000023551663777c17f6f7b4c567ef9421f6b5a949dbaf47a696da", merkleRootReversedHex: "f28b33a2a294ca879f65245cd5fe60d55db27abadb146993bc83f8d574b19027", timestamp: 1532135281, bits: 425766046, nonce: 1555164689),
                height: 1354749
        )
    }
    ...
    func testValidItem() {
        ...
        let block = Block(
                header: BlockHeader(version: 536870912, previousBlockHeaderReversedHex: "000000000000004b68d8b5453cf38c485b1b42d564b6a1d8487ec5ce662622ea", merkleRootReversedHex: "fde234b11907f3f6d45633ab11a1ba0db59f8aabecf5879d1ef301ef091f4f44", timestamp: 1532135309, bits: 425766046, nonce: 3687858789),
    ...
    func testValidItem_changeBits2() {
        let previousBlock = Block(
                header: BlockHeader(version: 536870912, previousBlockHeaderReversedHex: "00000000000000292d142fcc1ddbd9dafd4518310009f152bdca2a66cc589f97", merkleRootReversedHex: "48239e76f8b37d9c8824fef93d42ac3d7c433029c1e9fa23b6416dd0356f3e57", timestamp: 1532143012, bits: 424253525, nonce: 3410287696),
                height: 1354760
        )

        let block = Block(
                header: BlockHeader(version: 536870912, previousBlockHeaderReversedHex: "000000000000000127454a8c91e74cf93ad76752cceb7eb3bcff0c398ba84b1f", merkleRootReversedHex: "df50dc26ca3a5ac081e90b7c228c25319e018dd2ccd6d34e63c1919f80d25b0c", timestamp: 1532144219, bits: 486604799, nonce: 419922806),
                previousBlock: previousBlock
        )
