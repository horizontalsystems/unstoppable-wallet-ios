...
class BlockSaverTests: XCTestCase {
    ...
    override func setUp() {
        ...
        initialBlock = BlockFactory().block(withHeader: TestData.checkpointBlockHeader, height: 1)
    ...
    func testUpdateWithMerkleBlock() {
        ...
        let block = BlockFactory().block(withHeader: blockHeader, previousBlock: initialBlock)
