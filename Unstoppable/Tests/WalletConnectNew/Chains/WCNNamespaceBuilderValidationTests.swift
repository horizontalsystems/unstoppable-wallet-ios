...
struct WCNNamespaceBuilderValidationTests {
    ...
    private func proposals(required: [String: ProposalNamespace], optional: [String: ProposalNamespace]? = nil) -> [WCNBlockchainProposal] {
    ...
    @Test func optionalOnlyProposalAlwaysValidates() throws {
        let selected = proposals(required: [:], optional: WCNChainSupportFixtures.spikeOptional)
