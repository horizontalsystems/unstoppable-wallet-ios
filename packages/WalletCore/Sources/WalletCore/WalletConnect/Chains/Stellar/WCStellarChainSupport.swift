...
class WCStellarChainSupport: IWCChainSupport {
    private static let pubnet = WalletConnectUtils.Blockchain(namespace: WCNamespace.stellar, reference: "pubnet")

    let namespace = WCNamespace.stellar
