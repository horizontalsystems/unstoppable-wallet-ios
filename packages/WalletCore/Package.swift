...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/horizontalsystems/HsCryptoKit.Swift", exact: "1.3.1"),
        ...
        .package(url: "https://github.com/horizontalsystems/solana-kit-ios.git", exact: "1.0.0"),
