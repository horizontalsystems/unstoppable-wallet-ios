...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/horizontalsystems/solana-kit-ios.git", exact: "1.1.0"),
        ...
        .package(url: "https://github.com/horizontalsystems/zodl-swift-wallet-sdk", exact: "4.4.0-rc.2-hs.1"),
    ],
    targets: [
        .target(
            name: "WalletCore",
