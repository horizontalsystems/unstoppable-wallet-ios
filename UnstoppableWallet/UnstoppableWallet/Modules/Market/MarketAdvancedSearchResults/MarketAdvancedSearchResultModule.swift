...
enum MarketAdvancedSearchResultModule {
    static func viewController(marketInfos: [MarketInfo], priceChangeType: MarketModule.PriceChangeType) -> UIViewController {
        ...
        let watchlistToggleService = MarketWatchlistToggleService(coinUidService: service, watchlistManager: App.shared.watchlistManager, statPage: .advancedSearchResults)
