...
class MarketOverviewViewControllerNew: ThemeViewController {
    private let viewModel: MarketOverviewViewModelNew
    ...
    private var viewItems: [MarketOverviewViewModelNew.ViewItem]?

    init(viewModel: MarketOverviewViewModelNew, marketMetricsCell: MarketMetricsCellNew) {
    ...
    private func sync(viewItems: [MarketOverviewViewModelNew.ViewItem]?) {
    ...
    private func didTapSeeAll(listType: MarketOverviewServiceNew.ListType) {
