...
struct UsedAddressesView: View {
    ...
    @State private var currentTabIndex: Int = ReceiveAddressModule.AddressChain.external.rawValue
    ...
    var body: some View {
        ScrollableThemeView {
            VStack(spacing: .margin12) {
                ...
                ListSection {
                    if let key = ReceiveAddressModule.AddressChain(rawValue: currentTabIndex), let addresses = usedAddresses[key] {
