...
class SendZcashService {
    ...
    init(amountService: IAmountInputService, amountCautionService: AmountCautionService, addressService: AddressService, memoService: MemoInputService, adapter: ISendZcashAdapter, reachabilityManager: IReachabilityManager, platformCoin: PlatformCoin) {
