...
class SendZcashFactory: BaseSendFactory {
    ...
    init(service: SendZcashService, fiatService: FiatService, addressService: AddressService, memoService: MemoInputService, feeFiatService: FiatService, logger: Logger, platformCoin: PlatformCoin) {
