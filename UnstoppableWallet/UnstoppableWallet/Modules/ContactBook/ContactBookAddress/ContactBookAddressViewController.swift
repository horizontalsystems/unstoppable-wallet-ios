...
class ContactBookAddressViewController: KeyboardAwareViewController {
    ...
    private let onUpdateAddress: (ContactAddress?) -> Void
    ...
    init(viewModel: ContactBookAddressViewModel, addressViewModel: RecipientAddressViewModel, onUpdateAddress: @escaping (ContactAddress?) -> Void) {
