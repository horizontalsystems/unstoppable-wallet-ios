...
class ChooseCoinViewController: CoinToggleViewController {
    ...
    init(viewModel: ChooseCoinViewModel, sourceViewController: UIViewController?) {
    ...
    override func viewDidLoad() {
        ...
        title = "watch_address.choose_coin".localized
