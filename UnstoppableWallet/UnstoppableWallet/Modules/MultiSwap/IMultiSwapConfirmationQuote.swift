...
protocol IMultiSwapConfirmationQuote {
    ...
    func priceSectionFields(tokenIn: Token, tokenOut: Token, baseToken: Token, currency: Currency, tokenInRate: Decimal?, tokenOutRate: Decimal?, baseTokenRate: Decimal?) -> [TransactionField]
