...
struct WalletConnectSendEthereumTransactionRequestModule {
    ...
    static func viewController(baseService: WalletConnectService, requestId: Int) -> UIViewController? {
        ...
        let sendService = SendEvmTransactionService(sendData: SendEvmData(transactionData: service.transactionData, additionalInfo: nil), gasPrice: service.gasPrice, evmKit: evmKit, transactionService: transactionService)
