...
extension CoinAnalyticsViewController: SectionsDataSource {
    private func chartRow(id: String, title: String, valueInfo: String, chartCurveType: ChartConfiguration.CurveType, viewItem: Previewable<CoinAnalyticsViewModel.ChartViewItem>, isLast: Bool, infoAction: @escaping () -> Void, action: @escaping () -> Void) -> RowProtocol {
        let value: String
    ...
    private func previewableRow(id: String, title: String, value: Previewable<String>? = nil, accessoryType: CellBuilderNew.CellElement.AccessoryType = .none, isFirst: Bool = false, isLast: Bool = false, action: Previewable<() -> Void>? = nil) -> RowProtocol {
        var rowValue: String?
        var rowAction: (() -> Void)?
        ...
        if let value {
            ...
            case let .regular(value): rowValue = value
            }
        }
        ...
        if let action {
            switch action {
            case .preview: ()
            case let .regular(action): rowAction = action
            }
        }
    ...
    private func ratingRow(id: String, rating: Previewable<CoinAnalyticsModule.Rating>, isFirst: Bool = false, isLast: Bool = false, action: @escaping () -> Void) -> RowProtocol {
    ...
    private func valueRankSection(id: String, title: String, viewItem: CoinAnalyticsViewModel.ValueRankViewItem, onTapRank: @escaping () -> Void) -> SectionProtocol {
        let value: String?
