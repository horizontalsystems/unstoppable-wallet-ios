...
class MarketViewItemFactory {
    ...
    func viewItem(marketCap: Decimal?, marketCapRank: Int?, dilutedMarketCap: Decimal?, volume24h: Decimal?, tvl: Decimal?, genesisDate: TimeInterval?, circulatingSupply: Decimal?, totalSupply: Decimal?, currency: Currency, coinCode: String) -> CoinPageViewModel.MarketInfo {
