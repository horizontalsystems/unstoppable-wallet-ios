...
class CreateAccountViewModelNew: ObservableObject {
    ...
    @Published var wordCount: Mnemonic.WordCount = CreateAccountViewModelNew.defaultWordCount
...
extension CreateAccountViewModelNew {
