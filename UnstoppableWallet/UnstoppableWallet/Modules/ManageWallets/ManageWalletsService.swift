...
//
//        walletManager.activeWalletDataUpdatedPublisher.sink { [weak self] walletData in
//            self?.handleUpdated(wallets: walletData.wallets)
//        }.store(in: &cancellables)
//
//        restoreSettingsService.approveSettingsPublisher.sink { [weak self] tokenWithSettings in
//            self?.handleApproveRestoreSettings(token: tokenWithSettings.token, settings: tokenWithSettings.settings)
//        }.store(in: &cancellables)
//
//        restoreSettingsService.rejectApproveSettingsPublisher.sink { [weak self] token in
