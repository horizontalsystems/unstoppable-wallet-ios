...
class TronPrivateKeyViewController: ThemeViewController {
    private let viewModel: TronPrivateKeyViewModel

    private let tableView = SectionsTableView(style: .grouped)

    private var visible = false

    init(viewModel: TronPrivateKeyViewModel) {
    ...
    override func viewDidLoad() {
        ...
        title = "tron_private_key.title".localized
    ...
    private func toggle() {
        visible = !visible
        tableView.reload()
        stat(page: .tronPrivateKey, event: .toggleHidden)
    }
}

extension TronPrivateKeyViewController: SectionsDataSource {
                ...
                rows: [
                    ...
                    CellBuilderNew.row(
                        rootElement: .text { component in
                            ...
                            component.text = visible ? privateKey : "tron_private_key.tap_to_show".localized
