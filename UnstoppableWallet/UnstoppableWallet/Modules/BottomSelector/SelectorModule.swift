...
enum SelectorModule {
    ...
    static func bottomSingleSelectorViewController(image: BottomSheetTitleView.Image? = nil, title: String, subtitle: String? = nil, viewItems: [ViewItem], onSelect: @escaping (Int) -> Void) -> UIViewController {
...
extension SelectorModule {
    private static func row(viewItem: ViewItem, tableView: SectionsTableView, hash: String, accessoryElement: CellBuilderNew.CellElement, backgroundStyle: BaseThemeCell.BackgroundStyle, index: Int, isFirst: Bool = false, isLast: Bool = false, action: (() -> Void)? = nil) -> RowProtocol {
        CellBuilderNew.row(
            rootElement: .hStack([
    ...
    static func row(viewItem: ViewItem, tableView: SectionsTableView, selected: Bool, backgroundStyle: BaseThemeCell.BackgroundStyle, index: Int, isFirst: Bool = false, isLast: Bool = false, action: @escaping () -> Void) -> RowProtocol {
        row(
            viewItem: viewItem,
            tableView: tableView,
            hash: "\(selected)",
    ...
    static func row(viewItem: ViewItem, tableView: SectionsTableView, isOn: Bool, backgroundStyle: BaseThemeCell.BackgroundStyle, index: Int, isFirst: Bool = false, isLast: Bool = false, onToggle: @escaping (Int, Bool) -> Void) -> RowProtocol {
        row(
            viewItem: viewItem,
            tableView: tableView,
            hash: "\(isOn)",
