...
class SecurityViewController: ThemeViewController {
    private let viewModel: SecurityViewModel
    private let disposeBag = DisposeBag()

    private let tableView = SectionsTableView(style: .grouped)

    private var pinViewItem = SecurityViewModel.PinViewItem(enabled: false, editVisible: false, biometryViewItem: nil)
    ...
    private func sync(pinViewItem: SecurityViewModel.PinViewItem) {
...
extension SecurityViewController: SectionsDataSource {

    private func passcodeRows(viewItem: SecurityViewModel.PinViewItem) -> [RowProtocol] {
    ...
    private func biometryRow(viewItem: SecurityViewModel.BiometryViewItem) -> RowProtocol {
...
extension SecurityViewController: ISetPinDelegate {
...
extension SecurityViewController: IUnlockDelegate {
