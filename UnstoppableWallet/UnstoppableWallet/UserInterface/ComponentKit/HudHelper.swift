...
extension HudHelper {
    enum BannerType {
        ...
        var icon: UIImage? {
            ...
            case .decrypting: image = UIImage(named: "arrow_medium_2_down_24")
        ...
        var color: UIColor {
            ...
            case .waitingForSession, .disconnectingWalletConnect, .enabling,  .sending, .decrypting, .swapping, .approving, .revoking: return .themeGray
            }
        }
        ...
        var title: String {
            ...
            case .decrypting: return "alert.decrypting".localized
        ...
        var showingTime: TimeInterval? {
            switch self {
            case .waitingForSession, .disconnectingWalletConnect, .sending, .enabling, .decrypting: return nil
            default: return 2
            }
        }
        ...
        var isLoading: Bool {
            switch self {
            case .waitingForSession, .disconnectingWalletConnect, .enabling, .decrypting, .sending, .swapping, .approving, .revoking: return true
        ...
        var isUserInteractionEnabled: Bool {
            switch self {
            case .disconnectingWalletConnect, .enabling, .decrypting, .sending: return false
            default: return true
            }
        }
